...
////            ,"Gangapur Road","Gangapur Road","Panchavati","Panchavati","Satpur","Satpur","Dwarka","Shalimar Chowk","Shalimar","Cidco"," "};
    ...
    String name[]={"Memnagar Fire Station",

            "Jamalpur Fire Station",

            "Gomtipur Fire Brigade",

            "Maninagar Fire Station",

            "Dapaith Fire Station",

            "Naroda Fire Station",

            "Odhav Fire Station",

            "Panchkuva Fire Station"
           };
    String contact_no[]={"(079) 27417203",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Contacts of Fire Brigade");
